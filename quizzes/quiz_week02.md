...
7. (points = 10) What is the output at Line A?
  - Answer:
8. (points = 10) What is the output at Line B?
  - Answer:
9. (points = 10) What is the output at Line C?
  - Answer:
10. (points =10) What is the output at Line D?
  - Answer:
